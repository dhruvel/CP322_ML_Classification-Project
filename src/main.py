...
# Fit spambase data, trying different regularization lambdas, learning rates, and using 5-fold cross validation
...
best_model, accuracy, test_cost = find_best_logistic_model(
    ...
    max_cost_diff=5,
    learning_rates=[0.001, 0.01],
    regularization_lambdas=[0.1, 0.05, 0.03, 0.01],
    max_iterations=15000,
    test_split_ratio=0.9,
    print_acc=True,
    model_file="spambase_models_scores.csv",
)
